...
export default function RootLayout({
  ...
  if (pathname?.startsWith("/admin")) {
    return (
      <html lang="en">
        <body className={`${geistSans.variable} ${geistMono.variable} ${gilroy.variable} antialiased font-gilroy bg-gray-100`}>
          {children}
        </body>
      </html>
    );
            ...
            {/* Adjusted margin for different screen sizes */}
              <Link href="/" passHref>
               <Image
                  ...
                  alt="Lauv Logo"
                  width={70} // Base size for logo
                  height={70} // Base size for logo
                  ...
                  className="m-1 md:m-1 transition-all duration-300 hover:scale-150 hover:rotate-10 hover:brightness-125" // Adjusted margin
               />
              </Link>
